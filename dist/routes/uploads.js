...
import { 
// cargarArchivo, 
actualizarImagenCloudinary, mostrarImagenCloudinary } from '../controllers/index.js';
import { checkUploadsParam, validarArchivoSubir, validarCampos } from '../middlewares/index.js';
// -----------------------------------------------------
const router = Router();
// -----------------------------------------------------
